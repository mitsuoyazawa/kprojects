...
namespace PcapReceiver {
    public partial class Form1 : Form {
        ...
        private string alldispo(Stream rm) {
            string line;
            rm.Position = 0;
            txt = "";
            int time = 0;
        ...
        private void ReadWriteStream(Stream readStream, Encoding enc, string boundary) {
            Byte[] boundaryBytes = enc.GetBytes(boundary);
            ...
            string fullstring = alldispo(responseStream);
            ...
            Match match = rgx.Match(fullstring);
            ...
            string saveTo = textBox1.Text + filename;
            log.Debug("saveTo:" + saveTo);
            Stream writeStream = new FileStream(saveTo, FileMode.Create, FileAccess.Write);
        ...
        private void backgroundWorker4_DoWork(object sender, DoWorkEventArgs e) {
            ...
            while (true) {
                try {
                    ...
                    ReadWriteStream(context.Request.InputStream, context.Request.ContentEncoding, GetBoundary(context.Request.ContentType));
                    context.Response.StatusCode = 200;
                    context.Response.ContentType = "text/html";
                    using (StreamWriter writer = new StreamWriter(context.Response.OutputStream, Encoding.UTF8)) {
                        writer.WriteLine("File Uploaded - ");
        ...
        private void CheckIP() {
            ...
            foreach (IPAddress ip in host.AddressList) {
                ...
                if ((ip.ToString()).Contains("10.90.20")) {
                    ...
                    if (((ip.AddressFamily.ToString() == "InterNetwork")) && !localIP.Contains("10.90.20"))
                        localIP = ip.ToString();
        ...
        private void listBox1_MouseDown(object sender, MouseEventArgs e) {
            ...
            if (listBox1.SelectedIndex != -1) {
                ...
                if ((e.Button == MouseButtons.Left) && (Control.ModifierKeys == Keys.Control)) {
                    ...
                    string newfolder = filepath + "oldpcaps";
                    log.Info("from:" + file + " to:" + newfolder + filename);
                    if (!Directory.Exists(newfolder)) {
                        Directory.CreateDirectory(newfolder);
                    }
                    if (File.Exists(newfolder + filename)) {
                        File.Delete(newfolder + filename);
                    }
                    File.Move(file, newfolder+filename);
                ...
                log.Error("outlookErr:" + ex);
                MessageBox.Show("Outlook not detected");
            }
        }
    }
